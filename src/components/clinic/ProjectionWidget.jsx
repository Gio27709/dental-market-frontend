...
export default function ProjectionWidget({ projections }) {
  ...
  return (
    <div className="bg-white p-5 md:p-8 rounded-3xl border border-[#cdc3d4]/20 shadow-xs space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#cdc3d4]/20 pb-4">
        <div>
          ...
          <h3 className="text-lg md:text-xl font-bold text-[#111c2c] flex items-center gap-2">
        ...
        {/* Horizon Selector */}
        <div className="flex sm:inline-flex w-full sm:w-auto p-1 bg-[#f9f9ff] border border-[#cdc3d4]/30 rounded-2xl">
          {[30, 60, 90].map((days) => (
            <button
              key={days}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
        <div className="p-4 md:p-6 rounded-2xl bg-[#541a97]/5 border border-[#541a97]/15 flex flex-col justify-between">
          <p className="text-xs font-bold text-[#541a97] uppercase tracking-wider">
            Presupuesto Proyectado ({horizon} días)
          </p>
          <p className="text-2xl md:text-3xl font-black text-[#541a97] mt-2">
        ...
        <div className="p-4 md:p-6 rounded-2xl bg-[#ba1a1a]/5 border border-[#ba1a1a]/15 flex flex-col justify-between">
          <p className="text-xs font-bold text-[#ba1a1a] uppercase tracking-wider">
            Costo Urgente (Stock Crítico)
          </p>
          <p className="text-2xl md:text-3xl font-black text-[#ba1a1a] mt-2">
        ...
        <div className="p-4 md:p-6 rounded-2xl bg-[#006d37]/5 border border-[#006d37]/15 flex flex-col justify-between">
