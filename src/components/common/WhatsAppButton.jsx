...
// Vive en el layout público (EcommerceLayout), apilado encima del asistente en la esquina
// inferior derecha (el layout pone la posición fija): los paneles de admin, tienda, rider y
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 pl-3 pr-4 py-3 hover:bg-[#1ebe5b] active:scale-95 transition-all"
    >
