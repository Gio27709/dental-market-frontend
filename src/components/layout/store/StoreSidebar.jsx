  ...
  return (
    <aside className="w-[260px] flex-shrink-0 bg-[#f8f9fa] border-r border-gray-200 h-full flex flex-col hidden md:flex">
      ...
      <div className="h-[60px] flex items-center px-6 mb-4 mt-2">
        <Link to="/store" className="text-xl font-medium tracking-tight text-gray-800 flex items-center gap-2">
          <div className="w-6 h-6 rounded bg-primary-600 flex items-center justify-center">
            <span className="text-white text-xs font-bold">S</span>
          </div>
          <span className="font-semibold">DentalMarket<span className="font-light text-gray-500 text-sm ml-1">Store</span></span>
        </Link>
      </div>
          ...
          {soonLinks.map((link) => (
             <li key={link.name}>
               <a
                 ...
                 className="flex items-center gap-3 px-6 py-2.5 text-[14px] font-medium text-gray-500 hover:bg-gray-100/50 rounded-r-full transition-colors opacity-70 hover:opacity-100"
               >
                 <div className="text-gray-400">
                    {link.icon}
                 </div>
                 {link.name}
                 <span className="ml-auto inline-block bg-gray-200 text-gray-500 text-[9px] uppercase font-bold px-1.5 py-0.5 rounded-md">
                    Pronto
                 </span>
               </a>
             </li>
