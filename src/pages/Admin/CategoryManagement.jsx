        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
          {brands.map((brand) => (
            <div key={brand.id} className="group relative bg-white border border-gray-200 rounded-3xl p-6 hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/10 transition-all flex flex-col items-center justify-center min-h-[140px] text-center">
              ...
              {/* Acciones flotantes */}
              <div className="absolute top-3 right-3 flex flex-col gap-1 transition-all md:opacity-0 md:translate-x-2 md:group-hover:opacity-100 md:group-hover:translate-x-0 md:group-focus-within:opacity-100 md:group-focus-within:translate-x-0">
